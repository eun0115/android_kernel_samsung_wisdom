...
static int gpu_dvfs_update_config_data_from_dt(struct kbase_device *kbdev)
{
	...
	if (platform->gpu_max_clock_limit < 1100000||platform->gpu_max_clock < 1100000) 	// oc gpu
	platform->gpu_max_clock=platform->gpu_max_clock_limit=1100000;
#else
