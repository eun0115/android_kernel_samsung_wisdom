...
/*Overclocking little cores*/
static unsigned long arg_cpu_max_c1 = 1690000; /*max_freq=1.69 GHz*/
...
/*Overclocking big cores*/
unsigned long arg_cpu_max_c2 = 2184000; /*max_freq=2.18 GHz*/
					...
					struct device_node *dn)
{
	 ...
	 * selected to be the value defined in device
	 * tree. In case of min-freq, min frequency is selected
	 * to bigger one.
	 */
